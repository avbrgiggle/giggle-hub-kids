...
export default function ProviderSidebar() {
  ...
  return (
    <div className="w-64 h-screen p-4 border-r flex flex-col bg-background">
      <div className="mb-6">
      ...
      <div className="flex-grow overflow-y-auto space-y-4">
        ...
        <div className="space-y-1">
          <p className="text-xs font-medium text-muted-foreground px-3 py-1">ACTIVITIES</p>
          <NavItem
        ...
        <div className="space-y-1">
          <p className="text-xs font-medium text-muted-foreground px-3 py-1">MANAGEMENT</p>
          <NavItem
        ...
        <div className="space-y-1">
          <p className="text-xs font-medium text-muted-foreground px-3 py-1">FINANCIALS</p>
          <NavItem
            to="/provider/billing"
        ...
        <div className="space-y-1">
          <p className="text-xs font-medium text-muted-foreground px-3 py-1">INSIGHTS</p>
          <NavItem
