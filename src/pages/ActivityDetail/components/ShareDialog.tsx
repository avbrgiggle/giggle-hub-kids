...
export const ShareDialog = ({ open, onOpenChange, activityTitle, activityUrl }: ShareDialogProps) => {
  ...
  const shareViaTwitter = () => {
    window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Check out this activity: ${activityTitle}`)}&url=${encodeURIComponent(activityUrl)}`, '_blank');
    onOpenChange(false);
  };
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-4 mt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Button variant="outline" onClick={shareViaTwitter} className="flex gap-2 text-blue-500">
